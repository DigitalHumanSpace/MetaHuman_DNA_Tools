...
//Name: analog_gui-z_up.ma
//Last modified: Sat, May 13, 2023 11:45:29 PM
//Codeset: 936
requires maya "2022";
...
fileInfo "osv" "Windows 10 Education v2009 (Build: 22621)";
fileInfo "UUID" "9D9CD45A-4B1E-6400-C542-23A6D1F21256";
createNode transform -s -n "persp";
	rename -uid "1F733D66-48BC-F36A-95F0-85B776379FF9";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -49.741314604564216 257.23288351164075 -8.629795511731384 ;
	setAttr ".r" -type "double3" 79.775225669679514 2.2860236773019022e-15 -0.460309966942683 ;
	setAttr ".rp" -type "double3" 1.4210854715202004e-14 -2.8421709430404007e-14 -2.8421709430404007e-14 ;
	setAttr ".rpt" -type "double3" 48.400284204115174 -264.5993909891252 68.596066869525814 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "33E8B9B2-4CB3-2516-26DF-77BB12730D3B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".fcp" 1000;
	setAttr ".coi" 168.77537218535349;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.006649732589718127 158.72317366409303 30.006907165050507 ;
...
createNode transform -s -n "top";
	...
	setAttr ".rp" -type "double3" 0.28301886792452824 0.51457975986274263 -100.09999999999992 ;
	setAttr ".rpt" -type "double3" 0 -100.61457975986274 99.58542024013714 ;
...
createNode transform -s -n "front";
	...
	setAttr ".rp" -type "double3" 0.93640657189876109 -158.21400996191252 -184.61923504963326 ;
...
createNode transform -s -n "side";
	...
	setAttr ".rp" -type "double3" -2.222666495299562e-14 5.6843418860808015e-14 -100.09999999999997 ;
	setAttr ".rpt" -type "double3" -100.09999999999997 -5.6843418860808015e-14 100.09999999999997 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "210CD624-40C5-D3E6-AF59-E0A5082EF3E9";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "10DF9510-4033-E8C2-9971-84B4B0C32FC6";
createNode displayLayer -n "defaultLayer";
	rename -uid "8C781950-4A38-A1E6-7DB9-C9AE66742526";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "326DC77A-4D48-64D2-A034-9E821443853B";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5F7152B2-47BC-7FC8-004C-909607BD9E9A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "33A27317-4BE8-DCF7-B8D9-519C0DA36B8E";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -k on ".fzn";
