...
from ..ui import build_options_widget
reload(build_options_widget)
...
from ..ui import mesh_tree_list
reload(mesh_tree_list)
...
class ElementsCreator:
    ...
    def on_load_dna_clicked(self, input: FileChooser) -> None:
        ...
        if dna_file_path:
            ...
            self.elements.select_all_meshes_cb.setEnabled(True)
