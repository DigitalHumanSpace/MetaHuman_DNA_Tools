...
from ..ui import file_chooser
reload(file_chooser)
print("reloaded file chooser")
...
class Elements:
    ...
    @type select_all_meshes_cb: QCheckBox
    @param select_all_meshes_cb: The checkbox that represents if all meshes should be selected or deselected
    ...
    select_all_meshes_cb: QCheckBox = None
    ...
    def set_gui_path(self, path) -> None:
        """
        Gets the gui file path
        ...
        self.select_gui_path.set_file_path(path)
