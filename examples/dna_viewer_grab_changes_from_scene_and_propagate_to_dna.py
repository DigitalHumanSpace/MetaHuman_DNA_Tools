...
scriptPath = "E:\Projects\MetaHuman_DNA_Tools\examples\dna_viewer_grab_changes_from_scene_and_propagate_to_dna.py"
ROOT_DIR = f"{ospath.dirname(ospath.abspath(scriptPath))}/..".replace("\\", "/")
